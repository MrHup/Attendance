...
import com.babygirl.attendance.ui.dashboards.AttendanceListStudent;
import com.babygirl.attendance.ui.dashboards.Prof_Dashboard;
        ...
        AuthUI.getInstance()
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        startActivity(new Intent(Loading.this, SplashScreen.class));
